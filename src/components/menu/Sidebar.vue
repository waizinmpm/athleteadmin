    ...
    <div> 
     <!--sidebar-->  
        <ul class="list-group panel">
            <li class="list-group-item"><i class="glyphicon glyphicon-align-justify"></i> <b>管理画面</b></li>       
            <li>
