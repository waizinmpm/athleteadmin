<template>
    <div class="recruiter-profile-detail row">
        ...
        <dl class="detail-list border-bottom">
            ...
            <dd class="detail-data detail-group-topline">{{ recruiter_info.establishment_date }}</dd>
            ...
            <dd class="detail-data detail-group-topline">{{ recruiter_info.incharge_name }}</dd>
