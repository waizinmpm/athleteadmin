            ...
            <div class="col-sm-12 p-0 searchform-one">
                ...
                <div class="inner-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
							<label for="アスリート会員番号">{{ $t('jobapply_list.jobseeker_number') }}</label>
                ...
                <!--status click-->                    
                    ...
                    <span class="tooltip-box" v-if="visible">
                        <table class="tooltiptext">
                            ...
                            <tbody>
                                <tr><td class="w-105">応募／問合せ</td><td>アスリート会員から求人に応募があった。</td></tr>
                    ...
                    <div class="row d-flex"> 
                        <div class="col-sm-6">
                            ...
                            <div class="border">
                                ...
                                <dl class="row">
                                    <dt class="col-sm-2 txt-red text-right pr-0">{{ $t('common.invoice_amount') }}</dt>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 text-right pr-0">{{ $t('common.remark') }}</label>
                                    <div class="col-sm-9">
