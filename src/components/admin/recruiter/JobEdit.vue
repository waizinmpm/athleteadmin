<template>
  <div class="user-main">
    <h2 class="user-head-tit recruiter-primarylight-color">{{ $t('jobcreate.title') }}</h2>
    <div class="signin">
        <div class="signin-card-body" style="overflow:hidden;">
            ...
            <div class="d-flex justify-content-end">
                ...
                <button
                    ...
                    id="post"
                    value="確認"
                    class="btn btn-m primary-btn border-style delete-color"
